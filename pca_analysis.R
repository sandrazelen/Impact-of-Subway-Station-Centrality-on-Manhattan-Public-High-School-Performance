...
loadings<- my_data.pca$rotation[, 1:3]
print(loadings)
cor(my_data)
...
my_data <- my_data %>% select(-Student.Achievement)
print(as.matrix(my_data))
print(as.matrix(loadings))
...
pcs <- as.matrix(my_data) %*% as.matrix(loadings)
print(pcs)
