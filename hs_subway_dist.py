...
origins = [
    ...
    {"name": "Murry Bergtraum High School for Business Careers - [HS] 02M520", "lat": 40.71131, "lng": -74.001883},
    ...
    {"name": "High School for Dual Language and Asian Studies - [HS] 02M545", "lat": 40.7173162, "lng": -73.989318},
    ...
    {"name": "Fiorello H. LaGuardia High School of Music & Art and Performing Arts - [HS] 03M485", "lat": 40.7741856, "lng": -73.9851211},
    ...
    {"name": "Great Oaks Charter School - [HS] 84M202", "lat": 40.730716, "lng": -74.002974},
    {"name": "Capital Preparatory Harlem Charter School - [HS] 84M204", "lat": 40.8081605, "lng": -73.9387188},
    {"name": "Opportunity Charter School - [HS] 84M279", "lat": 40.8016724, "lng": -73.9554071},
    {"name": "Harlem Children's Zone Promise Academy Charter School - [HS] 84M284", "lat": 40.8123619, "lng": -73.9482983},
    {"name": "Girls Preparatory Charter School of New York - [HS] 84M330", "lat": 40.7127753, "lng": -74.0059728},
    {"name": "Harlem Village Academy East Charter School - [HS] 84M335", "lat": 40.7992798, "lng": -73.9339161},
    {"name": "KIPP Infinity Charter School - [HS] 84M336", "lat": 40.8194597, "lng": -73.9573186},
    {"name": "Harlem Children's Zone Promise Academy II Charter School - [HS] 84M341", "lat": 40.8123619, "lng": -73.9482983},
    {"name": "Democracy Preparatory Charter School - [HS] 84M350", "lat": 40.813171, "lng": -73.937603},
    {"name": "Success Academy Charter School - Harlem 1 - [HS] 84M351", "lat": 40.8025839, "lng": -73.9542374},
    {"name": "New Heights Academy Charter School - [HS] 84M353", "lat": 40.8286152, "lng": -73.9454018},
    {"name": "DREAM Charter School - [HS] 84M382", "lat": 40.789193, "lng": -73.944163},
    {"name": "Innovation Charter High School - [HS] 84M433", "lat": 40.7853407, "lng": -73.9423217},
    {"name": "Inwood Academy for Leadership Charter School - [HS] 84M478", "lat": 40.8622598, "lng": -73.9193593},
    {"name": "Democracy Preparatory Harlem Charter School - [HS] 84M481", "lat": 40.8115504, "lng": -73.9464769},
    {"name": "East Harlem Scholars Academy Charter School - [HS] 84M518", "lat": 40.7957399, "lng": -73.9389213},
    {"name": "Broome Street Academy Charter High School - [HS] 84M522", "lat": 40.7242016, "lng": -74.0048963},
    {"name": "Harlem Prep Charter School - [HS] 84M708", "lat": 40.7886777, "lng": -73.9448453},
    {"name": "Harlem Village Academy West Charter School - [HS] 84M709", "lat": 40.8065706, "lng": -73.944062},
...
def get_distances(origins, destinations):
    ...
    origin_batches = list(create_batch(origins, 4))
    destination_batches = list(create_batch(destinations, 4))
    for origin_batch in origin_batches:
        origins_str = '|'.join(f"{origin['lat']},{origin['lng']}" for origin in origin_batch)
        for destination_batch in destination_batches:
            destinations_str = '|'.join(f"{destination['lat']},{destination['lng']}" for destination in destination_batch)
...
get_distances(origins,destinations)